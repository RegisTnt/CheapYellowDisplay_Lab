...
public:
    ...
    static bool inWeatherBand(int16_t x, int16_t y);
...
private:
    ...
    void drawPersonIcon(int16_t x, int16_t y, uint16_t color);
    void drawCarIcon(int16_t x, int16_t y, uint16_t color);
